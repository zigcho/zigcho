...
function designSettings(account){
  ...
  add('profile','profile','change how your profile appears.',sections[0],true);
  const appearance=designElement('section','settings-section','<div class="settings-section-head"><h2>appearance</h2><p>your picture and banner, on the web and in game.</p></div>');appearance.append(avatar);avatar.querySelector('.account-note').textContent='png, jpeg or gif · up to 2 mb · drop a file here or choose one';if(extras[0]){extras[0].querySelector('.settings-section-head').innerHTML='<h3>banner</h3><p>png, jpeg or gif · up to 4 mb · 2000 × 500 px. drop a file here or choose one.</p>';appearance.append(extras[0])}add('appearance','appearance','your picture and banner, on the web and in game.',appearance);
  add('defaults','game defaults','choose the ruleset and score view your profile opens with.',sections[1],true);
  add('privacy','privacy','choose what other players can see. you and staff can still view your private profile details.',sections[2],true);
